    ...
    void Tablero::crearTableroVacio() { /* Crear exactamente 20 filas con 10 celdas
        (Lista enlazada de 20 nodos y cada nodo es un array de n=10)*/    
